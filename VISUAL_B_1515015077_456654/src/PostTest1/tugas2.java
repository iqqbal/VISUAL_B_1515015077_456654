...
public class tugas2 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        labelsuhu.setFont(new java.awt.Font("Swis721 WGL4 BT", 0, 12)); // NOI18N
        ...
        celcius.setBackground(new java.awt.Color(255, 153, 153));
        ...
        kelvin.setBackground(new java.awt.Color(255, 153, 153));
        ...
        farenheit.setBackground(new java.awt.Color(255, 153, 153));
        ...
        konversi.setBackground(new java.awt.Color(255, 102, 102));
        ...
        labelcls.setFont(new java.awt.Font("Swis721 WGL4 BT", 0, 12)); // NOI18N
        labelcls.setText("Celcius");

        labelkel.setFont(new java.awt.Font("Swis721 WGL4 BT", 0, 12)); // NOI18N
        labelkel.setText("Kelvin");

        labelfar.setFont(new java.awt.Font("Swis721 WGL4 BT", 0, 11)); // NOI18N
        labelfar.setText("Farenheit");

        tcelcius.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                tcelciusActionPerformed(evt);
            }
        });

        reamur.setBackground(new java.awt.Color(255, 153, 153));
        ...
        jLabel2.setFont(new java.awt.Font("Swis721 WGL4 BT", 0, 11)); // NOI18N
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addComponent(tfahrenheit, javax.swing.GroupLayout.PREFERRED_SIZE, 137, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                        .addComponent(suhuawal, javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(javax.swing.GroupLayout.Alignment.LEADING, jPanel2Layout.createSequentialGroup()
                            .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                .addComponent(tkelvin, javax.swing.GroupLayout.PREFERRED_SIZE, 137, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addComponent(tcelcius, javax.swing.GroupLayout.PREFERRED_SIZE, 137, javax.swing.GroupLayout.PREFERRED_SIZE))
                            .addGap(57, 57, 57)
                            .addComponent(jLabel2)
                            .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                            .addComponent(treamur, javax.swing.GroupLayout.PREFERRED_SIZE, 137, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addGroup(jPanel2Layout.createSequentialGroup()
                            .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel2Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                                    .addComponent(labelsuhu)
                                    .addComponent(suhuawal, javax.swing.GroupLayout.PREFERRED_SIZE, 28, javax.swing.GroupLayout.PREFERRED_SIZE))
                                .addGap(18, 18, 18)
                                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                                    .addComponent(celcius)
                                    .addComponent(kelvin)
                                    .addComponent(farenheit)
                                    .addComponent(reamur, javax.swing.GroupLayout.PREFERRED_SIZE, 23, javax.swing.GroupLayout.PREFERRED_SIZE)))
                            .addGroup(jPanel2Layout.createSequentialGroup()
                                .addGap(116, 116, 116)
                                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
    ...
    private void celciusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_celciusActionPerformed
        ...
        {
            c = Float.parseFloat(suhuawal.getText());
            rem = (4/5)*c;
            cel = c;
            far = ((9/5)*c)+32;
            kel = c+273;
    ...
    private void kelvinActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_kelvinActionPerformed
        ...
        {
            k = Float.parseFloat(suhuawal.getText());
            far = ((9/5)*(k-273))+32;
            cel = k-273;
            kel = k;
            rem = (4/5)*(k-273);
    ...
    private void farenheitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_farenheitActionPerformed
        ...
        {
            f = Float.parseFloat(suhuawal.getText());
            cel =((f-32)*5)/9;
            rem =((f-32)*4)/9;
            kel = (((f-32)*5)/9)+273;
            far = f;
    ...
    private void reamurActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_reamurActionPerformed
        ...
        {
            r = Float.parseFloat(suhuawal.getText());
            rem = r;
            cel = (5/4)*r;
            far = ((9/4)*r)+32;
            kel = ((5/4)*r)+273;
    ...
    private void konversiActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_konversiActionPerformed
        // TODO add your handling code here:
        tcelcius.setText(Float.toString(cel));
        tfahrenheit.setText(Float.toString(far));
        tkelvin.setText(Float.toString(kel));
        treamur.setText(Float.toString(rem));
        
    }//GEN-LAST:event_konversiActionPerformed

    private void tcelciusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_tcelciusActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_tcelciusActionPerformed
