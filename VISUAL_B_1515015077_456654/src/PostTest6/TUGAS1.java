...
public class TUGAS1 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setFont(new java.awt.Font("AngryBirds", 0, 12)); // NOI18N
        jLabel2.setForeground(new java.awt.Color(255, 255, 255));
        jLabel2.setText("Judul");

        jLabel3.setFont(new java.awt.Font("AngryBirds", 0, 12)); // NOI18N
        jLabel3.setForeground(new java.awt.Color(255, 255, 255));
        jLabel3.setText("Penulis");

        jLabel4.setFont(new java.awt.Font("AngryBirds", 0, 12)); // NOI18N
        jLabel4.setForeground(new java.awt.Color(255, 255, 255));
        jLabel4.setText("Harga");

        jComboBox1.setEditable(true);
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Muhammad Iqbal", "Rizaldi", "Zulkifli", "Deky Apriyandana", "Bayu Sakti", "Egi Dandy" }));
        ...
        jButton1.setFont(new java.awt.Font("AngryBirds", 1, 11)); // NOI18N
        ...
        jButton2.setFont(new java.awt.Font("AngryBirds", 1, 11)); // NOI18N
        ...
        jButton3.setFont(new java.awt.Font("AngryBirds", 1, 11)); // NOI18N
        ...
        jButton4.setFont(new java.awt.Font("AngryBirds", 1, 11)); // NOI18N
        ...
        jTable1.setFont(new java.awt.Font("AngryBirds", 1, 11)); // NOI18N
        ...
        jLabel5.setFont(new java.awt.Font("AngryBirds", 1, 11)); // NOI18N
        ...
        jLabel7.setFont(new java.awt.Font("AngryBirds", 1, 11)); // NOI18N
        jLabel7.setForeground(new java.awt.Color(255, 255, 255));
        jLabel7.setText("By");

        jLabel8.setText(":");

        jComboBox2.setFont(new java.awt.Font("AngryBirds", 0, 11)); // NOI18N
        ...
        jButton5.setFont(new java.awt.Font("AngryBirds", 1, 11)); // NOI18N
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        jComboBox1.setSelectedItem("Muhammad Iqbal");
        jTextField2.setText("");
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        ...
        if(jTextField3.getText().equals("")){           //mengambil tempat search untuk nilai yang kosong
            JOptionPane.showMessageDialog(null,"ISI DATA !!!"); //syntax ini digunakan untuk membuat pesan yang telah dibuat jika tidak mengisi kolom search
        }
        else{
